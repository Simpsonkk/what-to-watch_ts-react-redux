...
export const getMovieReviews = (state: State): Comment[] => state[NameSpace.Movies].movieReviews;
export const getSimilarMovies = (state: State): MovieData[] => state[NameSpace.Movies].similarMovies;
